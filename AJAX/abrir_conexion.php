...
//CONFIGURAR ESTE ESPACIO
	...
	$host 		 = "127.0.0.1:3406";    	// Nombre del servidor donde esta alojada nuestra base de datos
	$basededatos = "prueba_ajax";   // Nombre de la base de datos (¡Las mayusculas IMPORTAN!)
	$usuariodb 	 = "dev";    		// Nombre del usuario administrador de la base de datos
	$clavedb 	 = "secret";    			// Clave para acceder a la base de datos.
